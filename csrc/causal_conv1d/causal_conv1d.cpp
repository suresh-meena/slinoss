...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("cconv1d_fwd", &causal_conv1d_fwd, "Causal conv1d forward");
    m.def("cconv1d_bwd", &causal_conv1d_bwd, "Causal conv1d backward");
    m.def("cconv1d_update", &causal_conv1d_update, "Causal conv1d update");
}
